...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createMethodsProxy(Config, [
        ...
        , { methodName: 'loadFromFile', nativeName: 'loadFromFile', valueCallbackIndex: 0 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'getConflicts', nativeName: 'getConflicts', valueCallbackIndex: 0 }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createMethodsProxy(System, [
        ...
        , { methodName: 'setDoNotBackupAttribute', nativeName: 'setDoNotBackupAttribute', valueCallbackIndex: 2 }
          ...
          // function(/* int */ interval, /* const rho::String& */ url, /* const rho::String& */ url_params, /* optional function */ oResult)
        , { methodName: 'startTimer', nativeName: 'startTimer', valueCallbackIndex: 3 }
    
          // function(/* const rho::String& */ url, /* optional function */ oResult)
        , { methodName: 'stopTimer', nativeName: 'stopTimer', valueCallbackIndex: 1 }
